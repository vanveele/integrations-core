...
class KubeDNSCheck(GenericPrometheusCheck):
    """
    ...
    def create_generic_instances(self, instances):
        """
        Transform each Kube DNS instance into a GenericPrometheusCheck instance
        """
        generic_instances = []
    ...
    def _create_kube_dns_instance(self, instance):
        """
        Set up kube_dns instance so it can be used in GenericPrometheusCheck
        """
